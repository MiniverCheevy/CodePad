...
{
    public class ResponseHandlerFile : CodeFile
    {
        ...
        public ResponseHandlerFile(string projectName)
        {
            this.projectName = projectName;
            this.FileName = $"{projectName.ToKabobCase()}-response-handler.ts";
...
export class {projectName}ResponseHandler extends ResponseHandler {{
